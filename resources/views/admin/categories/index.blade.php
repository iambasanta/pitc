                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href="{{route('categories.destroy',$category->id)}}" class="p-2 text-danger" onclick="event.preventDefault();alert('Are you sure ?');document.getElementById('delete-form-{{$category->id}}').submit();">
