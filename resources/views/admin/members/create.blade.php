                            ...
                            <div class="card-body">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="example@email.com" value="{{old('email')}}" name="email" required>
                                        @error('email')
                                        <span class="text-sm invalid-feedback">
                                            <strong>{{$message}}</strong>
                                        </span>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('designation') is-invalid @enderror" id="designation" value="{{old('designation')}}" name="designation" required>
                                                @error('designation')
                                                <span class="text-sm invalid-feedback">
                                                    <strong>{{$message}}</strong>
                                                </span>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('batch') is-invalid @enderror" id="batch" value="{{old('batch')}}" name="batch" required>
                                                @error('batch')
                                                <span class="text-sm invalid-feedback">
                                                    <strong>{{$message}}</strong>
                                                </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="facebook" class="form-control @error('facebook') is-invalid @enderror" value="{{old('facebook')}}" name="facebook" required>
                                        @error('facebook')
                                        <span class="text-sm invalid-feedback">
                                            <strong>{{$message}}</strong>
                                        </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="linkedin" class="form-control" value="{{old('linkedin')}}" name="linkedin">
                                    </div>
                        ...
                        <div class="card-content ">
                            <div class="card-body">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div class="fileinput-preview fileinput-exists img-thumbnail" style="max-width: 450; max-height: 440;"></div>
                                    <div class="mt-2">
